  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-11">
            <h1>Sửa thông tin sản phẩm: <h5><?= $sanPham["ten_san_pham"]?></h5></h1>
          </div>
          <div class="col-sm-1">
                             ...
                             <table id="faqs" class="table table-hover">
                                 <thead>
                                     <tr>
                                         <th>Ảnh</th>
                                         <th>File</th>
                                         <th>  <div class="text-center"><button onclick="addfaqs();" type="button" class="badge badge-success"><i class="fa fa-plus"></i>Add</button></div>
                                         </div></th>
...
<script>
  var faqs_row = <?= count($listAnhSanPham)?>;
    function addfaqs() {
        ...
        html += '<td><img src="https://png.pngtree.com/png-vector/20190820/ourlarge/pngtree-no-avatar-vector-isolated-on-white-background-png-image_1694546.jpg" style="width:50px;height=50px;" alt=""></td>';
